...
<div class="mentoringinsert-wrap">
	...
	<div class="insert-form-wrap">
		<form action="<c:url value="/mentor/mentoring/insert"/>" method="post" class="mentoring-insert-form">
			<div class="mentoring-insert-wrap">
				<div class="mentoring-input-wrap">
					<div class="mentoring-form-group">
						...
						<br>
						<input type="text" name ="ment_title" class="ment_title" placeholder="맨토링 클래스 이름을 입력하세요">
					</div>
					<div class="mentoring-form-group">
						<label for="ment_duration">클래스기간</label>
						<br>
						<input type="date" name="ment_duration" class="ment_duration" placeholder="맨토링 클래스 종료일을 입력하세요">
					</div>
				</div>
				<div class="mentoring-input-wrap">
					<div class="mentoring-form-group">
				...
				<div class="text-wrap">
					...
					<textarea class="form-control ment_content" id="ment_content" name="ment_content"></textarea>
				</div>
...
$('.btn-submit').click(function(){
	...
	if(datas.category!==null&&checkStr(datas.title)&&checkStr(datas.content)&&checkStr(datas.duration)){
		if(confirm('해당 정보로 멘토링클래스 등록을 하시겠습니까?')){
